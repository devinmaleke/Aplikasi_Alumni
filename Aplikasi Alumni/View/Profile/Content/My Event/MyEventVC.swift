...
class MyEventVC: UIViewController {
    ...
    private func setTableView(){
        ...
        tableView.register(UINib(nibName: "MyEventEditTVC", bundle: nil), forCellReuseIdentifier: "MyEventEditTVC")
    }
...
extension MyEventVC: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellNews = tableView.dequeueReusableCell(withIdentifier: "MyEventTVC") as! MyEventTVC
        let cellEditNews = tableView.dequeueReusableCell(withIdentifier: "MyEventEditTVC") as! MyEventEditTVC
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let cell = tableView.cellForRow(at: indexPath) as? MyEventEditTVC {
